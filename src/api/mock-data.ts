...
export const MOCK_ALERTAS: AlertaHistorial[] = [
  ...
  { id: 4, tipo: 'FILTRO', nivel: 'ALERTA', rutTrabajador: '15.678.901-2', jornadaId: 1, timestamp: minutesAgo(25), activa: true, descripcion: 'Nivel de atollo elevado', valorMedido: 0.85, trabajador: MOCK_TRABAJADORES[3] },
